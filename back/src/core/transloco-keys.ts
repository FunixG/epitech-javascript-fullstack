export default class TranslocoKeys {
  static ENTITY_NOT_FOUND = 'server.entity.not_found';

  static BAD_REQUEST = 'server.bad-request';

  static BAD_REQUEST_MISSING_ID = 'server.bad-request-missing-id';

  static BAD_REQUEST_MISSING_USERNAME = 'server.bad-request-missing-username';
